...
const ENTREPRISE_ID = "REMPLACE_PAR_UUID_ENTREPRISE";

const repository = new PrismaProduitRepository();

export default async function ProduitsPage() {
  const produits = await listerProduits(repository, ENTREPRISE_ID);
    ...
    <main className="min-h-screen bg-zinc-50 px-4 py-10 text-zinc-900 sm:px-6 lg:px-8">
      <div className="mx-auto flex w-full max-w-5xl flex-col gap-8">
        ...
        <div className="grid gap-8 lg:grid-cols-[360px_1fr]">
          <ProduitForm entrepriseId={ENTREPRISE_ID} action={creerProduitAction} />
                    ...
                    {produits.map((produit) => (
                      <tr key={produit.id} className="align-top">
                        ...
                        <td className="px-4 py-3 align-top">
                          <ProduitActions entrepriseId={ENTREPRISE_ID} produit={produit} />
                        </td>
                      </tr>
                    ))}
                  </tbody>
